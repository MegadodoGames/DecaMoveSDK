...
namespace DecaSDK
{
    public class DecaMoveBehaviour : MonoBehaviour
    {
        ...
        private void Start()
        {
            try
            {
                DecaSDK.Move.OnStateUpdateDelegate OnStateUpdate = (Move.State state) =>
                {
                    lock (this)
                    {
                        _state = state;
                ...
                DecaSDK.Move.OnLogMessage OnLogMessage = (Move.LogLevel logLevel, string msg) =>
                {
                ...
                decaMove = new Move(OnFeedback, OnBatteryUpdate, OnOrientationUpdate, OnPositionUpdate, OnStateUpdate, OnLogMessage);
                try
                {
                }
